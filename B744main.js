...
(function() {
    ...
    const CONFIG = {
        on: {
            model: "https://OC135.github.io/test6/RB21136.glb",
            texture: "" // 元に戻す用のURL（空なら何もしない）
        },
        off: {
            model: "https://OC135.github.io/test6/RB21135.glb",
            texture: "" // 元に戻す用のURL（空なら何もしない）
        }
    };
    ...
    function injectUI() {
        ...
        panel.innerHTML = `
            <h3 style="margin:0 0 10px 0; font-size:14px; text-align:center;">RB211 addon</h3>
            <button id="toggle-uh60" style="width:100%; padding:10px; margin-bottom:10px; cursor:pointer; background:#444; color:white; border:none;">エンジン表示：OFF</button>
            <hr style="border:0.5px solid #555;">
            <button class="skin-btn" data-skin="on" style="width:100%; margin-top:10px; padding:8px; cursor:pointer; background:#179724; color:white; border:1px solid #0088cc; font-weight:bold;">RB211 only</button>
            <button class="skin-btn" data-skin="off" style="width:100%; margin-top:10px; padding:8px; cursor:pointer; background:#179724; color:white; border:1px solid #0088cc; font-weight:bold;">RB211 cargo</button>
        ...
        document.getElementById("toggle-uh60").onclick = function() {
            ...
            this.innerHTML = state.enabled ? "エンジン表示：ON" : "エンジン表示：OFF";
